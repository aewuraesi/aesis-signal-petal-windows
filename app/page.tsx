...
export default function Home() {
  ...
  const visible = useMemo(() => {
    ...
    if (metricFocus === "home-resolved") return issues.filter(i => isCompleteStatus(i.status));
    if (metricFocus === "home-overdue") return issues.filter(isOverdue);
    return issues.filter(i => !isCompleteStatus(i.status));
