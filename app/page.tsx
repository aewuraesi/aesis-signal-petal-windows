...
export default function Home() {
  ...
  function openMemoryRecord(issue: Issue) {
    ...
    setMemoryDetail(Boolean(kept?.rootCause.trim() || kept?.followUp.trim()));
